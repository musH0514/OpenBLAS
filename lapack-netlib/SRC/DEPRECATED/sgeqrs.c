...
/*  ===================================================================== */
/* Subroutine */ void sgeqrs_(integer *m, integer *n, integer *nrhs, real *a, 
	...
	lwork, integer *info)
{
    ...
    extern /* Subroutine */ void strsm_(char *, char *, char *, char *, 
	    ...
	    ), xerbla_(char *, integer *, ftnlen), sormqr_(char *, char *, integer *, integer *, integer *, 
