...
/*  ===================================================================== */
/* Subroutine */ void sgelqs_(integer *m, integer *n, integer *nrhs, real *a, 
	...
	lwork, integer *info)
{
    ...
    extern /* Subroutine */ void strsm_(char *, char *, char *, char *, 
	    ...
	    ), xerbla_(char *, integer *, ftnlen), slaset_(char *, integer *, integer *, real *, real *, 
